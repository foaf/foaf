...
<h1 title=" ">FOAF "Minimal" Validator</h1>
<div class="errors">
<ul>
...
<axsl:if test="rdfs:*">
<li>
<a title="Link to where this pattern was found" target="out" href="schematron-out.html#{generate-id(.)}">Error: illegal use of element from rdfs namespace
         ()
      </a>
</li>
</axsl:if>
<axsl:choose>
<axsl:when test="foaf:firstName or foaf:surname or foaf:nick or foaf:name"/>
<axsl:otherwise>
<li>
...
<axsl:if test="foaf:knows">
<li>
<a title="Link to where this pattern was found" target="out" href="schematron-out.html#{generate-id(.)}">Error: foaf:knows is not supported in FOAF Minimal
         ()
      </a>
</li>
</axsl:if>
...
<axsl:template mode="M5" priority="3997" match="foaf:Person">
<axsl:if test="true()">
<li>
<a title="Link to where this pattern was found" target="out" href="schematron-out.html#{generate-id(.)}">Error: Only a single person can be specified in a FOAF Minimal document
         ()
      </a>
</li>
</axsl:if>
...
<axsl:template mode="M5" priority="3996" match="foaf:mbox | foaf:mbox_sha1sum | foaf:geekcode | foaf:jabberID | foaf:aimChatID | foaf:icqChatID | foaf:yahooChatID | foaf:msnChatID | foaf:firstName | foaf:surname | foaf:family_name | foaf:homepage | foaf:weblog | foaf:plan | foaf:made | foaf:maker | foaf:img | foaf:depiction | foaf:myersBriggs | foaf:workplaceHomepage | foaf:workInfoHomepage | foaf:schoolHomepage | foaf:knows | foaf:interest | foaf:topic_interest | foaf:publications | foaf:currentProject | foaf:pastProject | foaf:fundedBy | foaf:logo | foaf:page | foaf:theme | foaf:holdsAccount">
<axsl:apply-templates mode="M5"/>
</axsl:template>
<axsl:template mode="M5" priority="3995" match="foaf:sha1 | foaf:based_near | foaf:depicts | foaf:thumbnail | foaf:topic | foaf:accountServiceHomepage | foaf:accountName | foaf:member | foaf:membershipClass">
<axsl:if test="true()">
<li>
<a title="Link to where this pattern was found" target="out" href="schematron-out.html#{generate-id(.)}">This element is not allowed in FOAF Minimal
         ()
      </a>
</li>
</axsl:if>
